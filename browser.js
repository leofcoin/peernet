...
require('@geut/discovery-swarm-webrtc');
require('wrtc');
...
class RequestMessage extends FormatInterface {
  ...
  constructor(data) {
    ...
    super(data, protons__default['default'](proto$6).PeernetRequestMessage, {name});
  }
}
...
class ResponseMessage extends FormatInterface {
  ...
  constructor(data) {
    ...
    super(data, protons__default['default'](proto$7).PeernetResponseMessage, {name});
  }
}
...
class PeerMessageResponse extends FormatInterface {
  ...
  constructor(data) {
    ...
    super(data, protons__default['default'](proto$8).PeernetPeerMessageResponse, {name});
  }
}
...
class DataMessageResponse extends FormatInterface {
  ...
  constructor(data) {
    ...
    super(data, protons__default['default'](proto$9).PeernetDataMessageResponse, {name});
  }
}
...
class Peernet {
  ...
  async _init(options) {
    ...
    if (daemon) {
      ...
      globalThis.accountStore = globalThis.accountStore ||
        new LeofcoinStorage$1('lfc-account', options.root);
      globalThis.walletStore = globalThis.walletStore ||
        new LeofcoinStorage$1('lfc-wallet', options.root);
      globalThis.blockStore = globalThis.blockStore ||
        new LeofcoinStorage$1('lfc-block', options.root);
      globalThis.chainStore = globalThis.chainStore ||
        new LeofcoinStorage$1('lfc-chain', options.root);
